...
RUN curl -sL https://deb.nodesource.com/setup_16.x | bash - && apt-get update && apt-get install -y nodejs && npm i -g typescript-language-server && npm i -g typescript && rm -rf /var/lib/apt/lists/*

ENV GOPATH="/go"

# gopls and golang-1.18
